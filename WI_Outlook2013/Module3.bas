...
' --- FLAGI SESJI (LOGIKA: NADPISZ/POMI� WSZYSTKIE) ---
...
' =========================================================
' 1. G��WNA PROCEDURA WYSZUKIWANIA
' =========================================================
Sub ZaawansowaneWyszukiwanieWI()
    ...
    If CzySzukacOutlook Then
        ' [NOWE] Inicjalizacja paska przed startem p�tli
        ...
        ' [NOWE] Obliczamy ca�kowit� ilo�� maili do paska
    ...
    If CzySzukacSerwer Then
        ...
        ' [NOWE] Zmienne do �ledzenia post�pu folder�w
    ...
    ' [NOWE] Zamkni�cie formularza z paskiem
    Unload frmSzukajWI
...
ErrorHandler:
    Unload frmSzukajWI ' [NOWE] Zabezpieczenie przed zablokowaniem formularza przy b��dzie
...
Private Function ZarzadzajKonfliktem(ByVal sciezka As String, fso As Object) As Boolean
    ...
    If pyt = vbCancel Then
        ...
        zb = MsgBox("Czy nadpisa� WSZYSTKIE duble?" & vbCrLf & "[TAK] = Wszystkie" & vbCrLf & "[NIE] = Pomi� wszystkie", vbYesNo + vbExclamation, "Decyzja zbiorcza")
...
Private Function OcjenReguly(subjekt As String, nadawca As String, nazwaPliku As String) As String
    ...
    For i = 1 To 20
        ...
        If cel = """" Then GoTo Nast�pnaRegula
...
Function PobierzSciezkeZapisu() As String
    ...
    If OstatniaSciezka <> "" Then
        odpowiedz = MsgBox("Wyniki s� gotowe do skopiowania." & vbCrLf & vbCrLf & _
                           ...
                           "Czy ZAPISA� JAK POPRZEDNIO?", vbYesNoCancel + vbQuestion, "Kreator zapisu")
